...
import { defaultOriginWhitelist, createOnShouldStartLoadWithRequest, defaultRenderError, defaultRenderLoading, } from './WebViewAmazonShared';
import styles from './WebViewAmazon.styles';
var UIManager = NotTypedUIManager;
var RNCWebViewAmazon = requireNativeComponent('RNCWebViewAmazon');
 ...
 */
var WebViewAmazon = /** @class */ (function (_super) {
    __extends(WebViewAmazon, _super);
    function WebViewAmazon() {
        ...
        _this.messagingModuleName = "WebViewAmazonMessageHandler" + (uniqueRef += 1);
        _this.componentDidMount = function () {
            BatchedBridge.registerCallableModule(_this.messagingModuleName, _this);
        };
        _this.getCommands = function () { return UIManager.getViewManagerConfig('RNCWebViewAmazon').Commands; };
        _this.goForward = function () {
            UIManager.dispatchViewManagerCommand(_this.getWebViewAmazonHandle(), _this.getCommands().goForward, undefined);
        };
        _this.goBack = function () {
            UIManager.dispatchViewManagerCommand(_this.getWebViewAmazonHandle(), _this.getCommands().goBack, undefined);
        };
        _this.reload = function () {
            _this.setState({
                viewState: 'LOADING'
            });
            UIManager.dispatchViewManagerCommand(_this.getWebViewAmazonHandle(), _this.getCommands().reload, undefined);
        };
        _this.stopLoading = function () {
            UIManager.dispatchViewManagerCommand(_this.getWebViewAmazonHandle(), _this.getCommands().stopLoading, undefined);
        };
        _this.requestFocus = function () {
            UIManager.dispatchViewManagerCommand(_this.getWebViewAmazonHandle(), _this.getCommands().requestFocus, undefined);
        };
        _this.postMessage = function (data) {
            UIManager.dispatchViewManagerCommand(_this.getWebViewAmazonHandle(), _this.getCommands().postMessage, [String(data)]);
        };
        _this.clearFormData = function () {
            UIManager.dispatchViewManagerCommand(_this.getWebViewAmazonHandle(), _this.getCommands().clearFormData, undefined);
        };
        _this.clearCache = function (includeDiskFiles) {
            UIManager.dispatchViewManagerCommand(_this.getWebViewAmazonHandle(), _this.getCommands().clearCache, [includeDiskFiles]);
        };
        _this.clearHistory = function () {
            UIManager.dispatchViewManagerCommand(_this.getWebViewAmazonHandle(), _this.getCommands().clearHistory, undefined);
        };
        /**
        ...
        _this.injectJavaScript = function (data) {
            UIManager.dispatchViewManagerCommand(_this.getWebViewAmazonHandle(), _this.getCommands().injectJavaScript, [data]);
        };
        /**
         ...
         */
        _this.getWebViewAmazonHandle = function () {
        ...
        _this.onShouldStartLoadWithRequestCallback = function (shouldStart, url, lockIdentifier) {
            if (lockIdentifier) {
                ...
                UIManager.dispatchViewManagerCommand(_this.getWebViewAmazonHandle(), _this.getCommands().loadUrl, [String(url)]);
            }
        };
        return _this;
    }
    WebViewAmazon.prototype.render = function () {
        ...
        if (this.state.viewState === 'LOADING') {
            ...
            console.error("RNCWebViewAmazon invalid state encountered: " + this.state.viewState);
        }
        ...
        if (typeof source !== "number" && source && 'method' in source) {
            if (source.method === 'POST' && source.headers) {
                console.warn('WebViewAmazon: `source.headers` is not supported when using POST.');
            }
            else if (source.method === 'GET' && source.body) {
                console.warn('WebViewAmazon: `source.body` is not supported when using GET.');
            }
        }
        var NativeWebViewAmazon = nativeConfig.component || RNCWebViewAmazon;
        ...
        var webView = (<NativeWebViewAmazon key="webViewKey" {...otherProps} messagingEnabled={typeof onMessage === 'function'} messagingModuleName={this.messagingModuleName} onLoadingError={this.onLoadingError} onLoadingFinish={this.onLoadingFinish} onLoadingProgress={this.onLoadingProgress} onLoadingStart={this.onLoadingStart} onHttpError={this.onHttpError} onRenderProcessGone={this.onRenderProcessGone} onMessage={this.onMessage} onShouldStartLoadWithRequest={this.onShouldStartLoadWithRequest} ref={this.webViewRef} 
    ...
    WebViewAmazon.isFileUploadSupported = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            // native implementation should return "true" only for Android 5+
            return [2 /*return*/, NativeModules.RNCWebViewAmazon.isFileUploadSupported()];
        });
    }); };
    return WebViewAmazon;
}(React.Component));
