...
import { WebViewAmazonErrorEvent, WebViewAmazonHttpErrorEvent, WebViewAmazonMessageEvent, WebViewAmazonNavigationEvent, WebViewAmazonProgressEvent, WebViewAmazonTerminatedEvent, MacOSWebViewAmazonProps, NativeWebViewAmazonMacOS, State } from './WebViewAmazonTypes';
declare class WebViewAmazon extends React.Component<MacOSWebViewAmazonProps, State> {
    static defaultProps: {
    ...
    state: State;
    webViewRef: React.RefObject<NativeWebViewAmazonMacOS>;
    getCommands: () => {
        goForward: number;
        goBack: number;
        reload: number;
    ...
    componentDidUpdate(prevProps: MacOSWebViewAmazonProps): void;
    showRedboxOnPropChanges(prevProps: MacOSWebViewAmazonProps, propName: keyof MacOSWebViewAmazonProps): void;
    render(): JSX.Element;
}
export default WebViewAmazon;
//# sourceMappingURL=WebViewAmazon.macos.d.ts.map