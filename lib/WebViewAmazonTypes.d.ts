...
declare type WebViewAmazonCommands = 'goForward' | 'goBack' | 'reload' | 'stopLoading' | 'postMessage' | 'injectJavaScript' | 'loadUrl' | 'requestFocus';
declare type AndroidWebViewAmazonCommands = 'clearHistory' | 'clearCache' | 'clearFormData';
...
export declare type RNCWebViewAmazonUIManagerAndroid = RNCWebViewAmazonUIManager<WebViewAmazonCommands | AndroidWebViewAmazonCommands>;
export declare type RNCWebViewAmazonUIManagerIOS = RNCWebViewAmazonUIManager<WebViewAmazonCommands>;
export declare type RNCWebViewAmazonUIManagerMacOS = RNCWebViewAmazonUIManager<WebViewAmazonCommands>;
export declare type RNCWebViewAmazonUIManagerWindows = RNCWebViewAmazonUIManager<WebViewAmazonCommands>;
declare type WebViewAmazonState = 'IDLE' | 'LOADING' | 'ERROR';
interface BaseState {
...
declare class NativeWebViewAmazonIOSComponent extends Component<IOSNativeWebViewAmazonProps> {
}
declare const NativeWebViewAmazonIOSBase: Constructor<NativeMethodsMixin> & typeof NativeWebViewAmazonIOSComponent;
export declare class NativeWebViewAmazonIOS extends NativeWebViewAmazonIOSBase {
}
declare class NativeWebViewAmazonMacOSComponent extends Component<MacOSNativeWebViewAmazonProps> {
}
declare const NativeWebViewAmazonMacOSBase: Constructor<NativeMethodsMixin> & typeof NativeWebViewAmazonMacOSComponent;
export declare class NativeWebViewAmazonMacOS extends NativeWebViewAmazonMacOSBase {
}
declare class NativeWebViewAmazonAndroidComponent extends Component<AndroidNativeWebViewAmazonProps> {
}
declare const NativeWebViewAmazonAndroidBase: Constructor<NativeMethodsMixin> & typeof NativeWebViewAmazonAndroidComponent;
export declare class NativeWebViewAmazonAndroid extends NativeWebViewAmazonAndroidBase {
}
declare class NativeWebViewAmazonWindowsComponent extends Component<WindowsNativeWebViewAmazonProps> {
}
declare const NativeWebViewAmazonWindowsBase: Constructor<NativeMethodsMixin> & typeof NativeWebViewAmazonWindowsComponent;
export declare class NativeWebViewAmazonWindows extends NativeWebViewAmazonWindowsBase {
}
...
export declare type WebViewAmazonEvent = NativeSyntheticEvent<WebViewAmazonNativeEvent>;
export declare type WebViewAmazonProgressEvent = NativeSyntheticEvent<WebViewAmazonNativeProgressEvent>;
export declare type WebViewAmazonNavigationEvent = NativeSyntheticEvent<WebViewAmazonNavigation>;
...
export declare type WebViewAmazonMessageEvent = NativeSyntheticEvent<WebViewAmazonMessage>;
export declare type WebViewAmazonErrorEvent = NativeSyntheticEvent<WebViewAmazonError>;
export declare type WebViewAmazonTerminatedEvent = NativeSyntheticEvent<WebViewAmazonNativeEvent>;
export declare type WebViewAmazonHttpErrorEvent = NativeSyntheticEvent<WebViewAmazonHttpError>;
export declare type WebViewAmazonRenderProcessGoneEvent = NativeSyntheticEvent<WebViewAmazonRenderProcessGoneDetail>;
...
export declare type WebViewAmazonSource = WebViewAmazonSourceUri | WebViewAmazonSourceHtml;
...
export {};
//# sourceMappingURL=WebViewAmazonTypes.d.ts.map