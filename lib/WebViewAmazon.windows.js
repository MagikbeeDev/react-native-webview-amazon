...
var RCTWebViewAmazon = requireNativeComponent('RCTWebViewAmazon');
...
var WebViewAmazon = /** @class */ (function (_super) {
    ...
    function WebViewAmazon() {
        ...
        _this.goForward = function () {
            UIManager.dispatchViewManagerCommand(_this.getWebViewAmazonHandle(), UIManager.getViewManagerConfig('RCTWebViewAmazon').Commands.goForward, undefined);
        };
        _this.goBack = function () {
            UIManager.dispatchViewManagerCommand(_this.getWebViewAmazonHandle(), UIManager.getViewManagerConfig('RCTWebViewAmazon').Commands.goBack, undefined);
        };
        _this.reload = function () {
            UIManager.dispatchViewManagerCommand(_this.getWebViewAmazonHandle(), UIManager.getViewManagerConfig('RCTWebViewAmazon').Commands.reload, undefined);
        };
        _this.injectJavaScript = function (data) {
            UIManager.dispatchViewManagerCommand(_this.getWebViewAmazonHandle(), UIManager.getViewManagerConfig('RCTWebViewAmazon').Commands.injectJavaScript, [data]);
        };
        _this.postMessage = function (data) {
            UIManager.dispatchViewManagerCommand(_this.getWebViewAmazonHandle(), UIManager.getViewManagerConfig('RCTWebViewAmazon').Commands.postMessage, [String(data)]);
        };
        /**
    ...
    WebViewAmazon.prototype.render = function () {
        ...
        var NativeWebViewAmazon = nativeConfig.component
            || RCTWebViewAmazon;
        var webView = (<NativeWebViewAmazon ref={this.webViewRef} key="webViewKey" {...otherProps} messagingEnabled={typeof onMessage === 'function'} onLoadingError={this.onLoadingError} onLoadingFinish={this.onLoadingFinish} onLoadingProgress={this.onLoadingProgress} onLoadingStart={this.onLoadingStart} onHttpError={this.onHttpError} onMessage={this.onMessage} onScroll={this.props.onScroll} onShouldStartLoadWithRequest={onShouldStartLoadWithRequest} source={resolveAssetSource(this.props.source)} style={webViewStyles} {...nativeConfig.props}/>);
